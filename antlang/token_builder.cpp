...
template class token_alternative_builder<protocol_token>;
template class token_alternative_builder<module_token>;
template class token_alternative_builder<import_token>;
template class token_alternative_builder<export_token>;
